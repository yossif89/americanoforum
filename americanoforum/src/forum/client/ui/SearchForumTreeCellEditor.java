 ...
 *
 */
public class SearchForumTreeCellEditor extends AbstractCellEditor implements
		TreeCellEditor {

	private static final long serialVersionUID = 180002002369366043L;

	private SearchForumTreeCellRenderer m_ftcr;

	public SearchForumTreeCellEditor(SearchForumTreeCellRenderer renderer) {
		m_ftcr = renderer;
	}
